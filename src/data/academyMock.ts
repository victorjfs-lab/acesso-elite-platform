...
export const demoCourses: Course[] = [
  {
    ...
    title: "Acesso Elite",
    subtitle: "Todos os cursos da plataforma em um unico acesso.",
    description:
      "Bundle especial para liberar todos os cursos publicados da plataforma em um unico cadastro.",
    heroImage:
  ...
  },
  {
    ...
    description:
      "Aula obrigatoria de boas-vindas para apresentar a area do aluno, a trilha dos cursos e o melhor caminho para consumir o Acesso Elite.",
    heroImage:
  ...
  },
  {
    ...
    slug: "radar-premium",
    title: "Radar Premium",
    subtitle: "Videoaulas, leitura pratica e rotina guiada de mercado.",
    description:
  ...
  },
  {
    ...
    title: "Sala de Indicadores",
    subtitle: "Leitura clara dos numeros que realmente mexem no preco.",
    description:
...
export const demoLinks: EnrollmentLink[] = [
  ...
  },
  {
    id: "link-radar-2026",
    courseId: "course-radar",
    slug: "turma-radar-2026",
    title: "Cadastro Radar Premium 2026",
    description: "Formulario publico para captar novos alunos desta turma.",
    isActive: true,
